...
<body>
    ...
    <form action="processa_cadastro.php" method="post" enctype="multipart/form-data">
        ...
        <div class="caixasDeSeparacao">
            ...
            <!-- Linha 2: Tamanho do motor, Tipo de motor -->
            <div class="linha">
                <!-- Tamanho do motor -->
                <div class="coluna">
                    <label for="tipo_veiculo">Tamanho do motor: <span style="color: red;">*</span></label>
                ...
                <!-- Tipo de motor -->
                <div class="coluna">
                    <label for="tipo_veiculo">Tipo de motor: <span style="color: red;">*</span></label>
                    <select name="tipo_veiculo" id="tipo_veiculo" required>
                        <option value="" disabled selected>Definir</option>
                    </select>
                </div>
                ...
                <!-- Tipo de combustível -->
                <div class="coluna">
                    <label for="tipo_veiculo">Tipo de combustível: <span style="color: red;">*</span></label>
                    <select name="tipo_veiculo" id="tipo_veiculo" required>
                        <option value="" disabled selected>Definir</option>
    ...
    <script>
        ...
        async function carregarDados() {
            try {
                const resposta = await fetch('/motors.json'); // Carregar o arquivo JSON
                const dados = await resposta.json(); // Converter a resposta em JSON
                
                // Preencher o select de tamanhos de motor
                const selectTamanho = document.getElementById('tamanho_motor');
                dados.tamanhos_motor.forEach(tamanho => {
                    const option = document.createElement('option');
                ...
                // Preencher o select de tipos de motor
                const selectTipo = document.getElementById('tipo_motor');
                dados.tipos_motor.forEach(tipo => {
                    const option = document.createElement('option');
                    option.value = tipo;
                ...
                console.error('Erro ao carregar dados do motor:', erro);
            }
        }

        // Carregar dados de motor assim que a página carregar
